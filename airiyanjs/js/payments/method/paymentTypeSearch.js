...
export class PaymentTypeSearch extends React.Component {
    ...
    actionRendered = (keyval, data) => {
        ...
        return (
            <PostTButton
                url="/service/paymenttype/change_enabled"
    ...
    render() {
        const { css = "", style = {}, enabledOnly = false } = this.props;
        const searchProps = {
            query: { query: {} },
            url: enabledOnly ? "/service/paymenttype/search/enabled" : "/service/paymenttype/search",
            views: [
                {
                    view: TableView,
