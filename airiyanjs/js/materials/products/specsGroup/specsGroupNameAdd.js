...
export class SpecsGroupNameAdd extends React.Component {
    constructor(props) {
        super(props)
    }
    ...
    onSuccess = (data) => {
        ...
        if (result === RESULT_SUCCESS) {
            this.POPUP.current?.showSuccess("Success", "Specs Group Name Added SuccessFully",()=>{ 
                this.props?.onClose()
                this.props?.refresh()
            });
