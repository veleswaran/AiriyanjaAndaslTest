...
import { SearchClientWeft } from "./searchClientWeft";
...
export class ClientWeftSelect extends React.Component {
                ...
                <div className="row">
                    ...
                    <div className="col text-end pe-1">
                        <button disabled={disabled} className="btn btn-sm btn-primary bi bi-plus-circle-fill" onClick={() => {
                            ...
                            this.POPUP.current?.showPopUp("Select Weft", SearchClientWeft, "", { modalProps: { size: 'xl', className: "bg-opacity-75 bg-dark" }, props: { query, onSelect: this.onSelect, needSearch: false } });
                        }}></button>
                    </div>
                </div>
            </div>
                ...
                <table className="table table-sm">
                    <thead>
                        <tr>
                            ...
                            <th className="table-secondary">Current Stock</th>
...
class wtSelectRow extends React.Component {
    ...
    render() {
        ...
        const { weft: { specDetails = [] } = {}, stock } = data;
        const names = [];
        ...
        return (
            <tr className="align-middle">
                ...
                <td className="table-secondary">{stock}</td>
                <td>
