...
document.addEventListener("DOMContentLoaded", () => {
    ...
    root.render(<>
        <ChipsSearch filters={filter} onUpdate={() => { console.log("Updated") }} />
        <p>
            nostrum, reprehenderit dolor voluptate harum ut vel repellat, repudiandae nam alias nisi delectus? Nisi ex eveniet consectetur natus veniam voluptatem alias qui sapiente earum quam. Porro aliquam ullam, quam vel ducimus fugiat ab autem ut neque, fugit ea! Totam est laborum expedita nisi doloremque? Aliquid, ea? Temporibus necessitatibus esse ipsum molestiae nulla minus aliquam vel consequatur modi. Autem odit odio, veritatis cupiditate deleniti sed culpa quis sapiente est dolore. Delectus, enim distinctio asperiores exercitationem nobis optio molestias blanditiis amet eum neque. Explicabo dolor labore dolorum architecto incidunt eos, asperiores nisi pariatur nostrum assumenda facere magni recusandae, deserunt optio similique. Minus molestiae repudiandae sunt incidunt illo, possimus nemo ullam dicta velit voluptatibus iusto ipsum fugiat reiciendis labore consequatur corrupti perspiciatis, saepe quae debitis officia iste! Suscipit quas labore fuga tempore laudantium animi? Esse, iste? Iusto tempora dicta, aliquam ea nihil eos magnam nulla, tenetur laudantium, asperiores maiores! Omnis officiis temporibus facilis est unde optio quod neque, fuga ullam sint, provident harum ex voluptas! Nihil fugiat alias doloremque, molestias debitis voluptatem dolor optio! Vel, est! Facilis quia in repellendus sunt consequuntur, magnam quibusdam perspiciatis cumque numquam nesciunt pariatur eaque placeat maiores, magni natus? Porro id voluptates blanditiis ea officia in neque, nostrum et eum repudiandae provident quasi minus labore similique rerum tenetur, quis expedita reiciendis corporis. Delectus animi saepe perspiciatis dolor?
        </p>
    </>);
});
